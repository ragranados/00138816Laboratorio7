...
enum parameters {TAU,KAPPA, LAMBDA,SIGMA,ETA, C_X, C_Y};
...
class mesh{
    ...
    public:
        void setParameters(float tau, float kappa, float lambda, float sigma, float eta, float c_x, float c_y){ // {TAU,KAPPA, LAMBDA,SIGMA,ETA, C_X, C_Y};
            parameters[TAU]=tau;
